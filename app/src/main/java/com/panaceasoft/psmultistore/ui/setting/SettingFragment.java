...
import com.panaceasoft.psmultistore.databinding.FragmentSettingBinding;
import com.panaceasoft.psmultistore.ui.common.PSFragment;
import com.panaceasoft.psmultistore.utils.AutoClearedValue;
import com.panaceasoft.psmultistore.utils.GetSizeTaskForGlide;
...
public class SettingFragment extends PSFragment {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().versionNumberTextView.setText(String.format(Locale.US, "%s%s%s", getString(R.string.setting__version_no), " ", Config.APP_VERSION));
    }
