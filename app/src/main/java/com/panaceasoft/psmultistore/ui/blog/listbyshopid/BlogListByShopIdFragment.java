...
import com.panaceasoft.psmultistore.databinding.FragmentBlogListByShopIdBinding;
 ...
 */
public class BlogListByShopIdFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {

    private final androidx.databinding.DataBindingComponent dataBindingComponent = new FragmentDataBindingComponent(this);
    private BlogViewModel blogViewModel;

    @VisibleForTesting
    private AutoClearedValue<FragmentBlogListByShopIdBinding> binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FragmentBlogListByShopIdBinding dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_blog_list_by_shop_id, container, false, dataBindingComponent);
    ...
    protected void initUIAndActions() {
                ...
                if (layoutManager != null) {
                    ...
                    if (lastPosition == adapter.get().getItemCount() - 1) {
                        ...
                        if (!binding.get().getLoadingMore() && !blogViewModel.forceEndLoading) {
                            ...
                            int limit = Config.LIST_NEW_FEED_COUNT_BY_SHOP_ID;

                            blogViewModel.offset = blogViewModel.offset + limit;

                            blogViewModel.setLoadingState(true);

                            blogViewModel.setNextPageNewsFeedByShopIdObj(selectedShopId, String.valueOf(Config.LIST_NEW_FEED_COUNT_BY_SHOP_ID), String.valueOf(blogViewModel.offset));
                        }
                    }
                }
            }
        ...
        binding.get().swipeRefresh.setOnRefreshListener(() -> {
            ...
            blogViewModel.setNewsFeedByShopIdObj(selectedShopId, String.valueOf(Config.LIST_NEW_FEED_COUNT_BY_SHOP_ID), String.valueOf(blogViewModel.offset));
    ...
    protected void initAdapters() {
        ...
        BlogListAdapter nvAdapter = new BlogListAdapter(dataBindingComponent, newsFeed -> navigationController.navigateToBlogDetailActivity(BlogListByShopIdFragment.this.getActivity(), newsFeed.id), this);
    ...
    protected void initData() {
        ...
        blogViewModel.setNewsFeedByShopIdObj(blogViewModel.shopId, String.valueOf(Config.LIST_NEW_FEED_COUNT_BY_SHOP_ID), String.valueOf(blogViewModel.offset));

        blogViewModel.getNewsFeedByShopIdData().observe(this, result -> {
        ...
        blogViewModel.getNextPageNewsFeedByShopIdData().observe(this, state -> {
            if (state != null) {
            ...
            if (getActivity() != null) {
                if (getActivity().getIntent() != null) {
                    if (getActivity().getIntent().getExtras() != null) {
                        blogViewModel.shopId = getActivity().getIntent().getExtras().getString(Constants.SHOP_ID);
