package com.panaceasoft.psmultistore.ui.notification.list;
...
import com.panaceasoft.psmultistore.databinding.FragmentNotificationListBinding;
...
import com.panaceasoft.psmultistore.ui.notification.list.adapter.NotificationListAdapter;
...
public class NotificationListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initAdapters() {
        ...
        nvAdapter = new NotificationListAdapter(dataBindingComponent, new NotificationListAdapter.NotificationClickCallback() {
            @Override
            public void onClick(Noti notification) {
                navigationController.navigateToNotificationDetail(NotificationListFragment.this.getActivity(), notification, notificationListViewModel.token);
            }
        }, this);
    ...
    private void replaceData(List<com.panaceasoft.psmultistore.viewobject.Noti> notificationList) {
