...
import com.panaceasoft.psmultistore.databinding.ItemDashboardViewpagerBlogBinding;
...
public class DashBoardViewPagerAdapter extends PagerAdapter {
    ...
    private DashBoardViewPagerAdapter.newsFeedClickCallBack callback;

    DashBoardViewPagerAdapter(androidx.databinding.DataBindingComponent dataBindingComponent,
    ...
    void replaceNewsFeedList(List<Blog> blogList) {
